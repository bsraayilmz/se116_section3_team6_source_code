...
public class Dungeon {
    ...
    public void displayDungeonInfo() {
        while (Characters.ChosenChar.size()>0) {
            ...
            if (floorNumber == 0) {
                ...
                System.out.println("If you are ready, please write 'I am ready' - not ready 'not ready'");
                String answer = input.nextLine();
                answer.toUpperCase(Locale.ROOT);
                if(answer.equalsIgnoreCase("I am ready")){
                    System.out.println();
    ...
    //it creates enemies according to the enemy number *2, there is a relation between enemy number and floor
    ...
    // with this method, the player choose if she wants to use special action of weapon of her character or not
            ...
            if (choice2 == (i + 1)) {
                ...
                if (attackOrSpecial == 1) {
                    ...
                    if(EnemyInBattle.get(indexOfChar).onHand[0].getKindWeapon()==1){
                        ...
                        EnemyInBattle.get(indexOfChar).onHand[0].printInfo();
                        System.out.println("Character list in the battle area that you can heal");
                        for (int n = 0; n < Characters.ChosenChar.size(); n++) {
                            System.out.println((n + 1) + "-" + " " + Characters.ChosenChar.get(n).getName());
                        }
    ...
    public void scoreKilled(){
        try {
            ...
            bufferedWriter.write("Your number of killed enemies: " + enemyKilled.size() + "\n");
            System.out.println();
