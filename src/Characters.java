...
public class Characters{
    ...
    public void controlCharForTankAndHealer() {
        ...
        System.out.println();
        System.out.println("NOW, SECONDLY PLEASE CHOOSE THE TANK BY WRITING 'LOOK AT TANKS' ");
        System.out.print("YOUR CHARACTER TYPE: ");
        String tankChoose;
        tankChoose = scanner.nextLine();
        tankChoose.toUpperCase(Locale.ROOT);
        while (!tankChoose.equalsIgnoreCase("look at tanks")) {
            System.out.println("!!! Your selection is not valid. Please enter 'look at tanks' !!!");
            System.out.print("YOUR CHARACTER TYPE: ");
            tankChoose = scanner.nextLine();
            tankChoose.toUpperCase(Locale.ROOT);

        }
        if (tankChoose.equalsIgnoreCase("look at tanks")) {
            tankChoose();
